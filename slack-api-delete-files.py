### credits go to @henry-p and @jackcarter
...
### minor changes to my preference, file size grater than 0 mb, so deletes all files more than 30 days.
...
# change to your file size 'mb' of your choice
files_by_size = filter_by_size(files, 0, 'greater')
